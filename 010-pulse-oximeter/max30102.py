...
#   It should also work with the MAX30102, which has a Green LED, too.             <- MAX30102 has no green led
    ...
    def check(self):
        ...
        if read_pointer != write_pointer:
            ...
            for i in range(number_of_samples):
                ...
                # BUG!! LED1 = RED (bytes 0:3), LED2 = IR (bytes 3:6)
                if self._active_leds > 0:
            ...
            return True  # put outside the for loop
